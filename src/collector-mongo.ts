...
const inserted = new client.Counter({
  name: "collector_mongo_inserted_total",
  help: "docs upserted",
  registers: [metricsRegistry],
});
startMetricsServer(metricsRegistry, Number(process.env.METRICS_PORT || "9101"));
  ...
  await kafkaBus.runConsumer({
    ...
    handler: async (buf) => {
      ...
      const pageDoc = {
        ...
        body: doc.body ?? null,
        detectedType: doc.detectedType || "page",
